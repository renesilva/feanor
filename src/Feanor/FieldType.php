...
abstract class FieldType  {
	...
	public function __construct ($_params = null, $_mode = null) {
		...
		if (isset($this->params['subtype'])) $this->subtype = $this->params['subtype'];
		if (isset($this->params['separator'])) $this->separator = $this->params['separator'];
		if (isset($this->params['value'])) $this->value = $this->params['value'];
		if (isset($this->params['conditions'])) $this->conditions = $this->params['conditions'];
		if (isset($this->params['required'])) $this->required = $this->params['required'];
