...
function remove_accent ($str)
{
    ...
    $b = array('A', 'A', 'A', 'A', 'A', 'A', 'AE', 'C', 'E', 'E', 'E', 'E', 'I', 'I', 'I',
        ...
        'a', 'a', 'a', 'a', 'ae', 'c', 'e', 'e', 'e', 'e', 'i', 'i', 'i', 'i', 'n', 'o', 'o',
        'o', 'o', 'o', 'o', 'u', 'u', 'u', 'u', 'y', 'y', 'A', 'a', 'A', 'a', 'A', 'a', 'C', 'c',
        ...
        'oe', 'R', 'r', 'R', 'r', 'R', 'r', 'S', 's', 'S', 's', 'S', 's', 'S', 's', 'T', 't', 'T', 't',
        'T', 't', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'W', 'w', 'Y', 'y', 'Y',
        'Z', 'z', 'Z', 'z', 'Z', 'z', 's', 'f', 'O', 'o', 'U', 'u', 'A', 'a', 'I', 'i', 'O', 'o', 'U',
...
/**
 * Funcion para cambiar las fechas y sean del tipo "Hace 2 meses"
 *
 * @param date $date
...
{
    if (empty($date)) {
        return "No se tiene la fecha";
    }
    $periods = array(
        "segundo", "minuto", "hora", "día", "semana", "mes", "año", "decada");
    $lengths = array(
    ...
    return "<span class='fecha'><strong>$date</strong> {$tense}&nbsp;$difference&nbsp;$periods[$j] </span>";
}
